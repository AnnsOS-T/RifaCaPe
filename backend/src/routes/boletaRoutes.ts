...
// GET /api/boletas/resultados - Obtener resultados del sorteo (público)
router.get('/resultados', BoletaController.obtenerResultados);

// GET /api/boletas/sorteo - Verificar estado del sorteo (público)
...
// POST /api/boletas/admin/:secretKey/finalizar-sorteo - Finalizar sorteo (protegido)
